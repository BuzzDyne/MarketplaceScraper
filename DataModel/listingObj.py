...
class ListingObj():
    def __init__(self, listingID = -1, listingName = '', priceProd = 0, soldCount = 0, seenCount = 0,  reviewScore = 0, reviewCount = 0, storeArea = '', storeName = '', listingURL = '', listingImgURL = '', listingThumbURL = '', timestamp = 0, listingStock = 0):
